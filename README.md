...
#### Project directory
[[Downloads]](https://drive.google.com/drive/folders/1qwW9aDUaXCJTvl_49fKNgqsXbuchYZsR?usp=sharing) Trained model, saved vocabularies and word embedding: glove-wiki-gigaword-50, label_vocab.pth, model_weights.pth, token_vocab.pth.
```
root
- data
- ed
